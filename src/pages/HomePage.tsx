...
const HomePage = memo(() => {
	...
	return (
		<Fragment>
		{isLoading ? <div className="h-screen  flex items-center text-center justify-center	"> <PulseLoader /></div>
: 
			(
		<Fragment>
		<h3 data-testid='heading' className="text-blue-600 text-2xl font-medium m-2 text-center pt-10">Welcome to Dungeons &amp; Dragons</h3>
